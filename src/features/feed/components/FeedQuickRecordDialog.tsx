...
type PostType = "quick-record" | "podcast" | "lecture";
...
type FeedQuickRecordDialogProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
};

function FeedQuickRecordDialog({ open, onOpenChange }: FeedQuickRecordDialogProps) {
...
export default FeedQuickRecordDialog;
